...
$(function() {
    ...
    $('#chooseZip').submit(function() { // bind function to submit event of form
    	...
    	var accessURL = "http://localhost/api/?interface=premise";
    	...
    	JSONP(accessURL,function(data)
    		{
    			...
    			$.each(data,function(i,val){
    				...
    				var latLong = val['Premise_coordinate'].replace(" ","").split(",");
					...
					allMarkers = new google.maps.Marker({
						...
						html: 
								'<div class="markerPop">' +
								'<p>' + val['Premise_name'] + '</p>' +
								'<p>' + val['Premise_Tel'] + '</p>' +
								'<p>' + val['Premise_name']+ ' Details: <a href="restaurant_details.html">'+
      'See More</a> ' + '<p>'+
								'</div>'
					});
